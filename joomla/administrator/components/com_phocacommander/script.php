...
{
    protected $extension 	= 'com_phocacommander';
    protected $updatetext 	= 'COM_PHOCACOMMANDER_UPDATE_TEXT';
    protected $installtext 	= 'COM_PHOCACOMMANDER_INSTALL_TEXT';
    protected $versiontext	= 'COM_PHOCACOMMANDER_VERSION';
    protected $extensiontext= 'COM_PHOCACOMMANDER';
    protected $configuretext= 'COM_PHOCACOMMANDER_CONFIGURE';
    ...
    function postflight($type, $parent)  {
        ...
        if ($type == 'update' || $type == 'install') {
			...
			$upEL = 'https://extensions.joomla.org/extension/phoca-commander/';
            $upE = 'Phoca Commander';
