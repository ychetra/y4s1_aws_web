...
$wp_customize->add_control( new LoginPress_Promo( $wp_customize, 'loginpress_customization[google_font]', array(
...
$wp_customize->add_control( new LoginPress_Promo( $wp_customize, 'loginpress_customization[recaptcha_error_message]', array(
